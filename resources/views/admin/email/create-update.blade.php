...
@section("content")
    ...
    <x-bootstrap.card>
        <x-slot:header>
            <h2 class="card-title">Theme {{ isset($theme) ? "Update" : "Create" }}</h2>
        </x-slot:header>
            ...
            <form action="{{ $theme ? route("admin.email-themes.edit") : "" }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="theme-select">
                    <div class="row">
                        ...
                        @endif
                        <div class="col-md-4">
                            <input type="text" name="name" id="name" class="form-control" placeholder="Theme Name" value="{{ $theme ? $name : "" }}">
                        </div>
                        <div class="col-md-4">
                            <select name="theme_type" id="theme-type" class="form-control" {{ $theme ? "disabled" : "" }}>
                                <option value="">Choose Theme Type</option>
                                <option value="1" {{ $theme && $theme_type == 1  ? "selected" : ""}}>I Want To Create Myself</option>
                                <option value="2" {{ $theme && $theme_type == 2  ? "selected" : ""}}>Password Reset Mail</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <select name="process" id="process" class="form-control" {{ $theme ? "disabled" : "" }}>
                                <option value="">Choose Process Type</option>
                                <option value="1" {{ $theme && $process == 1  ? "selected" : ""}}>Email Verify Mail Content</option>
                                <option value="2" {{ $theme && $process == 2  ? "selected" : ""}}>Password Reset Mail Content</option>
                                <option value="3" {{ $theme && $process == 3  ? "selected" : ""}}>After Password Reset Mail Content</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="content mt-5">
                    <div class="custom-content {{ $theme && $custom ? "" : "d-none" }}">
                        <div class="row">
                            <div class="col-12">
                                <h5>You can create your theme</h5>
                                <hr>
                                <h6>You can use this fields</h6>
                                <p>
                    ...
                    <div class="password-reset-mail {{ $theme && !$custom ? "" : "d-none" }}">
                        <div class="row">
                            <div class="col-12">
                                <h5>You Can Fill Password Reset Mail Fields.</h5>
                                <hr>
                            </div>
                            ...
                            <div class="col-6 mt-4">
                                <input type="text" name="passwordResetMail[title]" id="title" class="form-control" placeholder="Title" value="{{ $theme ? $title : "" }}">
                            </div>
                            <div class="col-6 mt-4">
                                <input type="text" name="passwordResetMail[description]" id="description" class="form-control" placeholder="Description" value="{{ $theme ? $description : "" }}">
                            </div>

                            <div class="col-6 mt-4">
                                <input type="text" name="passwordResetMail[button_text]" id="button_text" class="form-control" placeholder="Password Reset Button Text?" value="{{ $theme ? $button_text : "" }}">
                            </div>
                        ...
                        <div class="col-4 mt-4 theme-status {{ $theme ? "" : "d-none" }}">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="status">
                                    Do you want to assign active this theme?
                                </label>
                            </div>
                        </div>
