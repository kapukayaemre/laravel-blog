...
@php
    if (isset($theme))
    ...
    else
        {
            ...
            $logoAlt = "Password Reset";
            $logoTitle = "Password Reset";

            $buttonText = "Reset";
            $description = "Click the link for reset the password";

            $resetPasswordImage = asset($settings->reset_password_image);
            $resetPasswordImageAlt = "Reset Password";
            $resetPasswordImageTitle = "Reset Password";
